    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                var productoEncontrado = await _productoRepositorio.Obtener(prod => prod.IdProducto == productoModelo.IdProducto);
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                var productoEncontrado = await _productoRepositorio.Obtener(prod => prod.IdProducto == id);

                if (productoEncontrado == null)
                    throw new TaskCanceledException("No existe ese producto");
